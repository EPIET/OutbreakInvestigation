...
# Introduction to the `R` compendium
This document is meant as a compendium to the *Copenhagen* case study as taught at the ***EPIET*** *Outbreak Investigation*-module in December 2021. This document is not meant as a general introduction to **R** statistical computation software.  
...
The following code has been updated from the [https://github.com/EPIET/OutbreakInvestigation](UK FETP version) of the case study to modern **R!** utilizing the [https://www.tidyverse.org/](*tidyverse*) and other contemporary packages. Some parts are adapted from the [https://epirhandbook.com/en/](*EpiR-Handbook*). 
...
# Data management and different file types in `R`

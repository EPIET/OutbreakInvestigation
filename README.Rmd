...
This repository is for the development and maintenance of R teaching material for use in the EPIET (European Programme of Intervention Epidemiology Training) and UK FETP (United Kingdom Field Epidemiology Training Programme) **Outbreak Investigation (OI) module**.

The module includes two computer-based outbreak investigation case studies and a GIS mapping exercise; the help guides for these exercises have been translated from the STATA version into R. 
...
Then:
 ...
 - Navigate to the `Files` tab within RStudio and open the relevant case study folder 

...
For this case study, the following materials have been provided:
   ...
   + [Mapping in R case study guide](https://epiet.github.io/OutbreakInvestigation/Mapping_R_guide.html) (online version)
...
ukbb <- osmdata::getbb(place_name = "United Kingdom", 
                       featuretype = "country")
...
# First, define the boundaries of the map you want to import:
englandbb <- osmdata::getbb(place_name = "England", 
